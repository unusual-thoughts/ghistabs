...
|------|-------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------|
| A1   | `./gradlew test --tests "ghistabs.parse.ParserPrimitiveTest"`     | Exit 0; 11 tests PASSED                                                                               |
| A2   | `./gradlew test --tests "ghistabs.parse.ParserClassTest"`         | Exit 0; 7 tests PASSED including testMethodNoParametersVoidSentinel and testMethodImplicitThisPointer |
| A3   | `./gradlew test --tests "ghistabs.parse.ParserBugfixTest"`        | Exit 0; testStructXRef, testUnionXRef, testEnumXRef, testDeeplyNestedInlineDef PASSED                 |
| A4   | `./gradlew test --tests "ghistabs.parse.HarvesterGlobalizeTest"`  | Exit 0; 7 tests PASSED                                                                                |
| A5   | `./gradlew test --tests "ghistabs.parse.HarvesterAppendAstsTest"` | Exit 0; 4 tests PASSED                                                                                |
| A6   | `./gradlew test --tests "ghistabs.parse.HarvesterPassATest"`      | Exit 0; 10 tests PASSED                                                                               |
| A7   | `./gradlew test --tests "ghistabs.parse.HarvesterGapTest"`        | Exit 0; active tests PASSED, D2/D3/D7 @Disabled skipped                                               |
| A8   | `./gradlew test --tests "ghistabs.parse.IncludeContextTest"`      | Exit 0; 9 tests PASSED                                                                                |
...
3. Open `HarvesterGapTest.kt`; for each D-ID confirm the corresponding test (active, @Disabled, or `correct`-comment)
   matches the row's rating.
