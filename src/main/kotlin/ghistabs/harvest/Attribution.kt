 ...
 * one physical header compiled under several build roots (`.../project/image.h` from a Jenkins tree
 ...
 * `result/include/project/`. Among several equally-parented paths the **shallowest** wins,
