...
class ClassBuilder(
     ...
     * own a real vtable that nothing ever visits — 53 of unpackfile's 58 `_ZTV` symbols.
     *
     ...
     * `do_widen`/…, and one name across all of them forks a `.conflict` per slot (32 on unpackfile).
