 ...
 * unbouniaf's `error()`, which calls `exit` and cannot return, is exactly that. Left unmarked,
 ...
 * the dead `ret` and the walk concludes the function returns. Measured on unbouniaf: the
