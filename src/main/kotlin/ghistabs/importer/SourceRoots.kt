 ...
 * — `…/util/xvimage/` under a project checkout is the same directory, whatever is above it. Then the
...
class LocalSources(
     ...
     *
     * [MIN_AGREEMENT] is measured, not guessed. Against gcc 3.2.3 — the version unpackfile was built
