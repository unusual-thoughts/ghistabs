...
class VtableSymbolCandidatesTest {
    ...
    fun testItaniumMangledClassNameSimple() {
        val result = VtableSymbolCandidates.itaniumMangleClassName("bouniaf")
        assertEquals("10bouniaf", result)
    }
    ...
    fun testItaniumDecodesToClassMatches() {
        assertTrue(
            VtableSymbolCandidates.itaniumDecodesToClass("_ZTV10ThisStream", "bouniaf"),
            "Should decode _ZTV10ThisStream to bouniaf",
        )
    }
    ...
    fun testItaniumDecodesToClassMatchesCygwinVariant() {
        assertTrue(
            VtableSymbolCandidates.itaniumDecodesToClass("__ZTV10ThisStream", "bouniaf"),
            "Should decode __ZTV10ThisStream (Cygwin variant) to bouniaf",
        )
    }
    ...
    fun testItaniumDecodesToClassNoMatch() {
        assertFalse(
            VtableSymbolCandidates.itaniumDecodesToClass("XYZ_ZTV9ThisStream", "bouniaf"),
