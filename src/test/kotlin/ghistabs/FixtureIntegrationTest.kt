...
class bouniafbouniafIntegrationTest {
     ...
     * [ghistabs.integration.StabsAnalyzerRegressionTest] which loads bouniafbouniaf.exe through
    ...
    fun testbouniafbouniafRealBinary() {
        ...
        // For bouniafbouniaf.exe, we expect some globals to fail due to address conflicts.
