 ...
 *
 * Goal: pin down whether the 14 xref-ambiguous on xapasmcsr.exe are
    ...
    fun diagnoseXapasmcsr() {
        ...
        ProgramLoader.builder()
            ...
            .load().use { loadResults ->
                ...
                val resolver = TypeResolver(harvest, ctx.options.canonicalizePaths, ctx)
