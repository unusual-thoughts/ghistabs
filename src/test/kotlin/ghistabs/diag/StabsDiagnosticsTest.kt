...
class StabsDiagnosticsTest {
    ...
    fun testRecordDedupMergeCounter() {
        ...
        assertEquals(1, diag["dedup-merge"])
    }
    ...
    fun testRecordDedupDropCounter() {
        ...
        assertEquals(1, diag["dedup-drop"])
    }
    ...
    fun testRecordDedupRenameCounter() {
        ...
        assertEquals(1, diag["dedup-rename"])
    }
    ...
    fun testMultipleDedupCounters() {
        ...
        assertEquals(2, diag["dedup-merge"])
        assertEquals(1, diag["dedup-drop"])
        assertEquals(1, diag["dedup-rename"])
    }
    ...
    fun testDedupCountersInSummary() {
        ...
        assertTrue(output.contains("dedup-merge = 1"))
        assertTrue(output.contains("dedup-drop = 1"))
        assertTrue(output.contains("dedup-rename = 1"))
    }
}
