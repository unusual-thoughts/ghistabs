...
class IncludeSpellingTest {
    ...
    fun projectHeadersStayQuotedAndKeepTheirSubdirectory() {
        ...
        includeSpellingOf("E:/work/cc/devtools/devtools-bluelab-7-0/result/include/imageutil/appimage.h") mustBe
            """"imageutil/appimage.h""""
        includeSpellingOf("C:/Jenkins/workspace/BlueSuite/bc/bluesuite_2_6/interface/host/bits/bits64.h") mustBe
            """"bits64.h""""
    }
}
