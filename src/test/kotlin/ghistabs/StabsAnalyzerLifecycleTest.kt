 ...
 * AC1.5 (no-stabs): Tested with integration tests on real binaries via XapasmcsrIntegrationTest.
 ...
 * It is covered by integration tests (XapasmcsrIntegrationTest) which use real binaries.
 */
