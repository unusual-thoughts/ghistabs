...
fun Array<*>.mustBeEmpty(msg: String? = null) = assertTrue(isEmpty(), msg)
fun Array<*>.mustNotBeEmpty(msg: String? = null) = assertTrue(isNotEmpty(), msg)
...
fun String.mustBeEmpty(msg: String? = null) = assertTrue(isEmpty(), msg)
fun String.mustNotBeEmpty(msg: String? = null) = assertTrue(isNotEmpty(), msg)
