...
class AttributionTest {
    ...
    fun realHeaderWinsOverFakeHeaderSibling() {
        ...
        attr.keyFor("XapArgInst", sources).category mustBe CategoryPath("/proj/include/inst.h")
    }
    ...
    fun allFakeHeadersFallBackToMultiBucket() {
        ...
        attr.keyFor("XapArgInst", sources).category mustBe CategoryPath("/proj/inst.cpp/multi")
    }
    ...
    fun windowsDriveLetterStrippedFromCuPath() {
        ...
        cat.category mustBe CategoryPath("/work/cc/adk/apps/sink/main.cpp")
    }
    ...
    fun commonProjectPrefixStripsWindowsDriveLetter() {
        ...
        commonProjectPrefix(sources) mustBe "/work/cc/adk/apps/sink"
    }
