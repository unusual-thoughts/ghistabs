...
class IncludeSpellingTest {
    ...
    fun projectHeadersStayQuotedAndKeepTheirSubdirectory() {
        ...
        assertEquals(
            ...
            includeSpellingOf("E:/work/cc/devtools/devtools-bouniaf-7-0/result/include/imageutil/appimage.h"),
        )
        assertEquals(
            """"bits64.h"""",
            includeSpellingOf("C:/Jenkins/workspace/project/bc/bluesuite_2_6/interface/host/bits/bits64.h"),
        )
    }
}
