...
class IncludeSpellingTest {
    ...
    fun projectHeadersStayQuotedAndKeepTheirSubdirectory() {
        ...
        assertEquals(
            ...
            includeSpelling("E:/work/cc/devtools/devtools-bouniaf-7-0/result/include/imageutil/appimage.h"),
        )
        assertEquals(
            """"bits64.h"""",
            includeSpelling("C:/Jenkins/workspace/project/bc/bluesuite_2_6/interface/host/bits/bits64.h"),
        )
    }
}
