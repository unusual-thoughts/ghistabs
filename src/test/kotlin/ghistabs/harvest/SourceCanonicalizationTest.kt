...
class SourceCanonicalizationTest {
    ...
    fun ambiguousBasenameDoesNotMerge() {
        ...
        val map = canonicalizeSourcePaths(inputs)
    ...
    fun fullPathWithoutBareSpellingStays() {
        ...
        val map = canonicalizeSourcePaths(listOf("/work/include/dspinfo/dspinfo.h", "packfile.cpp"))
    ...
    fun backslashPathsFoldToo() {
        ...
        val map = canonicalizeSourcePaths(listOf("foo.h", """C:\work\include\foo.h"""))
    ...
    fun differentExtensionsAreDistinctFiles() {
        ...
        val map = canonicalizeSourcePaths(listOf("dspinfo.c", "/work/include/dspinfo/dspinfo.h"))
