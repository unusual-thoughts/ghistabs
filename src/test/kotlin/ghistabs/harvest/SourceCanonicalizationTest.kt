...
class SourceCanonicalizationTest {
    ...
    fun bareFoldsUniqueFullPath() {
        ...
        val map = canonicalizeSourcePaths(listOf("header.h", "/work/include/project/header.h"))
    ...
    fun fullPathWithoutBareSpellingStays() {
        ...
        val map = canonicalizeSourcePaths(listOf("/work/include/project/header.h", "file.cpp"))
    ...
    fun differentExtensionsAreDistinctFiles() {
        ...
        val map = canonicalizeSourcePaths(listOf("file.c", "/work/include/project/header.h"))
