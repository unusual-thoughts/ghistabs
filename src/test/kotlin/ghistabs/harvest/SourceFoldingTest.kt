...
class SourceFoldingTest {
    ...
    fun bareFoldsOntoItsFullPath() {
        ...
        map.getValue("/dspinfo.h") mustBe "/work/include/dspinfo/dspinfo.h"
        map.getValue("/work/include/dspinfo/dspinfo.h") mustBe "/work/include/dspinfo/dspinfo.h"
    }
    ...
    fun sameHeaderUnderDifferentBuildRootsFolds() {
        ...
        for (i in map.keys) map.getValue(i) mustBe "/jenkins/bluesuite/result/include/xvimage/image.h"
    }
    ...
    fun equalDepthRootsPickTheSameOneEveryTime() {
        ...
        for (i in map.keys) map.getValue(i) mustBe "/jenkins/include/xvimage/image.h"
        reversed mustBe map
    }
    ...
    fun differentExtensionsAreDistinctFiles() {
        ...
        map.getValue("/dspinfo.c") mustBe "/dspinfo.c"
        map.getValue("/work/include/dspinfo/dspinfo.h") mustBe "/work/include/dspinfo/dspinfo.h"
    }
}
